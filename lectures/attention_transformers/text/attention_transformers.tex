...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.5\textwidth]{repin_unexpected_visitor}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{The attention path is linked to the task}

\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{Yarbus2}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Human visual attention mechanisms}
...
\begin{frame}{Spatial transformers with multiple heads}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\textwidth]{spatial_transformers_birds}
  \end{figure}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\textwidth]{transformer_with_zooms}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Success of transformers in natural language processing -- some examples}

  \begin{itemize}
  \item Bidirectional Encoder Representations from Transformers (BERT, by Google~\cite{brown_language_2020})
  \item Generative Pre-trained Transformer 3 (GPT-3, by OpenAI~\cite{devlin_bert_2019}): 175 billion parameters ; GPT4 (2023) ; GPT5 (2025) ...
    \item Llama models, by Meta (Open Source)
    \item Le Chat, by Mistral AI
    \item etc...
    \item Chatbot arena: \url{https://lmarena.ai/}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.95\textwidth]{vision_transformer}
\end{figure}
...
\begin{frame}{Mean attention distance}
    ...
    \begin{figure}[ht]
    \centering
    \includegraphics[width=0.45\textwidth]{mean_attention_distance}
  \end{figure}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.4\textwidth]{rabbit_eagle.jpg}
  \includegraphics[width=0.4\textwidth]{rabbit.jpg}
\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{And the winner is ...~\cite{liu_convnet_2022}}
