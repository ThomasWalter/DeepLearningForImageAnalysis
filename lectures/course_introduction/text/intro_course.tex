...
\vspace{2em}
  ...
  \begin{column}{.8\textwidth}
    ...
    \begin{block}{Thomas Walter (CBIO)}
      \scriptsize{
    \begin{itemize}
  ...
  \begin{block}{Santiago Velasco-Forero (CMM/STIM)}
      \scriptsize{
    \begin{itemize}
  ...
  \end{block}
    ...
    \begin{block}{Etienne Decencière (CMM/STIM)}
      \scriptsize{
    \begin{itemize}
    \item Researcher on image analysis, mathematical morphology, deep learning; director of the Center for Mathematical Morphology (CMM/STIM)
...
\begin{frame}{Course organization}
  ...
  \begin{block}{Communication}
    ...
    \begin{itemize}
  \item \url{https://cours.cmm.minesparis.psl.eu}
  \item E-mail
    \begin{itemize}
...
\begin{frame}{Teaching assistants}
  ...
  \begin{block}{Practical work sessions}
  \begin{itemize}
  \item October 7, 21, 28
  \item November 4
  \end{itemize}
  \end{block}
...
\begin{itemize}
\item Assignments
\item Exam : November 11 at 10h45, on paper, with no access to course material or the Internet
\end{itemize}
