...
\frame{
 ...
 Here an image is a 2D array of size $p \times q$. Each array element belongs to $\R^d$. The dimension of the value space $d$, is often called the \alert{number of channels} of the image.
  ...
  \begin{block}{Examples}
    \begin{figure}
      \centering
      \includegraphics[width=3cm]{mnist_example_5}
      ~~~~~~~~
...
\begin{frame}{Learning image transformations}
  ...
  \item An image classification task is a function from the set of considered images into a set of labels
      \begin{figure}
      \includegraphics[width=0.80\textwidth]{image_classif.png}
      \end{figure}
\end{itemize}
    \end{column}
\pause
  ...
  \item In many applications, we want to transform an image into another image
      \begin{figure}
      \includegraphics[width=0.80\textwidth]{image_transf0.png}
      \end{figure}
  \end{itemize}
...
\frame{
  ...
  \begin{block}{Definition: image-to-image translation}
    An image-to-image operator is a function that transforms an image into another image.

    The number of channels and the spatial sizes of input and output images can be different.
  \end{block}

      \begin{figure}
      \includegraphics[width=0.40\textwidth]{image_transf0.png}
      \end{figure}
...
\frame{
  \frametitle{Counting cells}
    ...
    \begin{figure}
      \includegraphics[width=0.65\textwidth]{lazard}
...
\begin{frame}{Microscopy cross-modality prediction\cite{ounkomol_label-free_2018}}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=0.75\textwidth]{microscopy_modality_pred}
  \end{figure}
...
\frame{
  ...
  \begin{block}{Example}
    \begin{figure}
      \centering
      \includegraphics[height=4.5cm]{pascal_moto}
      \hspace{1em}
      \includegraphics[height=4.5cm]{pascal_moto_seg}\\
...
\begin{frame}{From classification to image-to-image translation}
  ...
  \begin{columns}
    \begin{column}{.5\textwidth}
      \begin{figure}
      \includegraphics[width=0.9\textwidth]{image_classif.png}
      \end{figure}
    ...
    \begin{column}{.5\textwidth}
      \begin{figure}
      \includegraphics[width=0.9\textwidth]{image_transf.png}
      \end{figure}
...
\begin{columns}
  \begin{column}{.5\textwidth}
      \begin{figure}
      \includegraphics[width=0.9\textwidth]{image_transf1.png}
      \end{figure}
  ...
  \begin{column}{.5\textwidth}
      \begin{figure}
      \includegraphics[width=0.9\textwidth]{image_transf2.png}
      \end{figure}
...
\begin{frame}{From classification nets to image-to-image nets}
      ...
      \begin{figure}
      \includegraphics[width=0.4\textwidth]{image_transf_fin.png}
      \end{figure}
...
%%   \begin{figure}
%%   \includegraphics[width=0.6\textwidth]{receptive_field_upsampling.png}
%%   \end{figure}
...
\frame{
  ...
  Answer: if the input image is large enough, then its size is $1 + 2 \times (n+1)$
  }
  }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% \frame<handout>{
...
\end{block}
  ...
  \begin{figure}
    \includegraphics[width=0.6\textwidth]{effective_receptive_field.png}
  \end{figure}
...
\begin{figure}[ht]
  \centering
  \includegraphics[height=0.60\textheight]{fundus1}\\
  \pause
...
\frame{
  ...
  \item Depending on the complexity of the segmentation task, the number of filters or the number of layers can be reduced
...
\frame{
  ...
  \begin{figure}
    \includegraphics[width=0.75\textwidth]{unet_lo}
  \end{figure}
...
\frame{
  ...
  \begin{figure}
    \includegraphics[width=0.70\textwidth]{unet_lo}
  \end{figure}
...
\begin{frame}{U-Net main ideas}
      ...
      \begin{figure}
        \includegraphics[width=0.66\textwidth]{unet_lo}
      \end{figure}
...
\frame{
  ...
  \begin{columns}
    ...
    \begin{column}{.3\textwidth}
      \includegraphics[width=0.75\textwidth]{Intersection_of_sets_A_and_B}
...
%%     \begin{columns}[c]
%%     \column{.5\textwidth}
%%         \includegraphics[width=0.7\textwidth]{hst.jpg}\\
