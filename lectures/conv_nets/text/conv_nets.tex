%\documentclass[handout,xcolor=pdftex,dvipsnames,table,mathserif,aspectratio=169]{beamer}
...
\newcommand{\source}[1]{\begin{textblock*}{4cm}(11.7cm,8.1cm)
...
\begin{frame}{A picture is worth a thousand words}
  ...
  \begin{columns}
    ...
    \begin{column}{.4\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=0.85\textwidth]{../graphics/faune.png}\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{What is special about natural images?}

  \begin{columns}
    \begin{column}{.27\textwidth}
      \begin{figure}[ht]
        \centering
        \includegraphics[width=\textwidth]{bureau-1}
      \end{figure}
...
\begin{columns}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{applis_dl_sup}
  \end{figure}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{applis_dl_nonsup}
  \end{figure}
...
\frame{
  ...
  \item[\boldmath$\ominus$] The features might only partly reflect the underlying truth.
  \end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Pascal VOC project \tiny{\cite{everingham_pascal_2009, everingham_pascal_2014}}}
  ...
  \centering
  \includegraphics[width=0.65\textwidth]{pascal_examples.png}
...
\begin{frame}{ImageNet projet}
  ...
  \centering
  \includegraphics[width=0.15\textwidth]{ilsvrc_guitar2}\hspace{0.1em}
  \includegraphics[width=0.15\textwidth]{ilsvrc_guitar3}\\
  \includegraphics[width=0.30\textwidth]{ilsvrc_guitar1}\hspace{0.1em}
  \includegraphics[width=0.30\textwidth]{ilsvrc_guitar4}\\
...
\frame{
  ...
  \begin{columns}
    ...
    \begin{column}{.4\textwidth}
      \centering
      \scriptsize
      \includegraphics[height=0.65\textheight]{ImageNet_error_history}
...
\frame{
  ...
  \item 2011: first super-human performance, IJCNN 2011 traffic sign recognition contest \cite{ciresan_committee_2011}
    \begin{figure}[ht]
      \centering
      \includegraphics[width=0.6\textwidth]{ijcnn2011.png}
...
\end{quizzblock}
  ...
  \mode<beamer>{
    ...
    \item Using one-hot encoding, we make the labels permutation equivariant
  \end{itemize}}
...
\begin{frame}{Comparing probability distributions}
  ...
  %% \end{tabular}
  %::::::::::::::::::::::::::::::
  \centerline{  \includegraphics[width=0.4\textwidth]{dog_image.png}}
...
\begin{frame}{Cross-entropy}
  ...
  The dissimilarity between two probability distributions is estimated by the Kullback-Leibler divergence.

  \begin{block}{  Definition: Kullback-Leibler (KL) divergence}

  Consider two discrete probability distributions $P$ and $Q$. The KL-divergence of $P$ with respect to $Q$ is:

  \[D_{KL}(P,Q)=\sum\limits_i P_i\log \frac{P_i}{Q_i} = \sum\limits_i P_i \log(P_i) - \sum\limits_i P_i \log(Q_i) \]

  \end{block}

  In our case, $P$ represents the ground-truth and $Q$ is the prediction of our network.
Therefore, the first term $\sum\limits_i P_i \log(P_i)$ is the entropy of the ground truth labels, that does not depend on $\theta$. Finally:

  \[\underset{\theta}{\mathrm{argmin}}[ D_{KL}(P,Q)] = \underset{\theta}{\mathrm{argmin}}[- \sum\limits_i P_i \log(Q_i)] = H(P,Q) \Rightarrow \textcolor{blue}{\text{Cross-Entropy formula}}\]
%https://www.youtube.com/watch?v=SxGYPqCgJWM
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Cross-entropy as a classification loss function}
...
\begin{frame}{Cross-entropy}
 ...
 %\includegraphics<1>[width=0.3\textwidth]{cross_entropy_loss_1.png}
 %\includegraphics<2>[width=0.3\textwidth]{sq_CE_losses_1.png}
 \includegraphics[width=0.5\textwidth]{sq_CE_grad_1.png}
  \end{center}
...
\begin{frame}{Image classification with a fully-connected NN}
  ...
  \begin{block}{Example: image of size $4 \times 2$, $6$ possible classes}
    \centering
    \includegraphics[width=0.4\textwidth]{mini_reseau3_bis}
  \end{block}
...
\frame{
  ...
  \begin{columns}
    ...
    \begin{column}<1->{0.3\textwidth}
      \begin{center}
        \includegraphics[width=0.61\textwidth]{fully_connected_layer.png}
    ...
    \begin{column}<2->{0.3\textwidth}
      \begin{center}
        \includegraphics[width=0.61\textwidth]{locally_connected_layer.png}
    ...
    \begin{column}<3->{0.3\textwidth}
      \begin{center}
        \includegraphics[width=0.61\textwidth]{convolutional_layer.png}
...
\frame{
  ...
  \begin{columns}
    ...
    \begin{column}<1->{0.33\textwidth}
      \begin{center}
        \includegraphics[width=0.51\textwidth]{stride1.png}
        \\ \scriptsize{Stride 1}
      \end{center}
    \end{column}
    ...
    \begin{column}<2->{0.33\textwidth}
      \begin{center}
        \includegraphics[width=0.51\textwidth]{stride2.png}
        \\ \scriptsize{Stride 2}
      \end{center}
    \end{column}
    ...
    \begin{column}<3>{0.33\textwidth}
      \begin{center}
        \includegraphics[width=0.51\textwidth]{stride3.png}
        \\ \scriptsize{Stride 3}
      \end{center}
    \end{column}
...
\begin{frame}{Dilated convolutions}
  ...
  \begin{columns}
    ...
    \begin{column}<1->{0.33\textwidth}
      \begin{center}
        \includegraphics[width=0.51\textwidth]{dil_conv1.png}
    ...
    \begin{column}<2->{0.33\textwidth}
      \begin{center}
        \includegraphics[width=0.51\textwidth]{dil_conv2.png}
    ...
    \begin{column}<3->{0.33\textwidth}
      \begin{center}
        \includegraphics[width=0.51\textwidth]{dil_conv3.png}
...
\frame{
  ...
  \begin{center}
    \includegraphics[width=0.49\textwidth]{convolutional_layer3.png}
...
\frame{
  ...
  \begin{center}
    \includegraphics[width=0.49\textwidth]{convolutional_layer4.png}
...
\frame{
  ...
  \begin{center}
    \includegraphics[width=0.31\textwidth]{max_pooling.png}
  \end{center}

  \pause

  Note however that the preferred approach today is to use convolutional layers with a stride of 2
...
\begin{frame}{Branch merging: concatenation}
  ...
  \begin{center}
    \includegraphics[width=0.41\textwidth]{concatenation.png}
  \end{center}
...
\begin{frame}{Branch merging: addition}
  ...
  \begin{center}
    \includegraphics[width=0.41\textwidth]{addition.png}
  \end{center}
...
\begin{frame}{2D representations}
  ...
  \centering
  \includegraphics[width=0.75\textwidth]{fovea_convnet2}
...
\frame{
  ...
  \begin{center}
    \begin{figure}
      \includegraphics[width=0.55\textwidth]{vgg16.png}
      \source{VGG16 (From https://www.cs.toronto.edu/~frossard/post/vgg16/)}
    \end{figure}
  \end{center}
  ...
  \begin{columns}
    ...
    \begin{column}{.65\textwidth}
      \begin{block}{Architecture}
        \begin{figure}[ht]
          \centering
          \includegraphics[width=0.6\textwidth]{mobilenet}
        \end{figure}
