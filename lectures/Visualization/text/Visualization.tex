...
\end{figure}
\begin{itemize}
	\item CNNs learn representations of the images (last layers prior to classification).  
	\item We can now collect these representations $\{x_i\}_{i=1\ldots N}$ for all images in the training set. 
...
% \begin{figure}[htb]
%   \centering
%   \includegraphics[width=\textwidth]{../graphics/Vis_tsne.png}
% \end{figure}
% \end{frame}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=\textwidth]{../graphics/Vis_tsne_imagenet1.png}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=\textwidth]{../graphics/Vis_tsne_imagenet2.png}
  \source{adapted from \url{https://cs.stanford.edu/people/karpathy/cnnembed/}}
\end{figure}
\end{frame}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=\textwidth]{../graphics/Vis_tsne_imagenet3.png}
  \source{adapted from \url{https://cs.stanford.edu/people/karpathy/cnnembed/}}
\end{figure}
\end{frame}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=.9\textwidth]{../graphics/Vis_CAM_principle.png}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=.8\textwidth]{../graphics/Vis_CAM_Barbell.png}
  \source{adapted from \cite{Zhou:2016}}
\end{figure}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=.8\textwidth]{../graphics/Vis_CAM_Dome.png}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=.7\textwidth]{../graphics/Vis_GRADCAM_cat_and_dog.png}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=.7\textwidth]{../graphics/Vis_GRADCAM_Counter.png}
  \source{adapted from \cite{Selvaraju:2020}}
\end{figure}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=.6\textwidth]{../graphics/Vis_GRADCAM_bias.png}
  \source{adapted from \cite{Selvaraju:2020}}
\end{figure}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=.9\textwidth]{../graphics/Vis_dream.png}
...
\begin{frame}{Looking at activation maps}
   \begin{columns}
      \column{0.38\linewidth}
		\begin{figure}[htb]
				\centering
				\includegraphics[width=3.5cm]{../graphics/Vis_looking_activation_maps.png}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=.96\textwidth]{../graphics/Vis_unpooling2.png}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=\textwidth]{../graphics/Vis_Layer2_activationmaps.png}
\end{figure}
...
\begin{figure}[htb]
  \centering
  \subfloat{\includegraphics[height=.3\textheight]{../graphics/Vis_activationmaps_training1.png}}\\  
  \subfloat{\includegraphics[height=.3\textheight]{../graphics/Vis_activationmaps_training2.png}} 
\end{figure}
\begin{itemize}
...
% \begin{figure}[htb]
%   \centering
%   \includegraphics[width=\textwidth]{../graphics/Vis_activationmaps_training.png}
% \end{figure}
% \end{frame}
...
\begin{figure}[htb]
\includegraphics[width=0.9\textwidth]{../graphics/Vis_resnet_without_skip_2d.png}
...
\begin{figure}[htb]
\includegraphics[width=0.9\textwidth]{../graphics/Vis_resnet_with_skip_2d.png}
...
\begin{figure}[htb]
  \centering
  \subfloat{\includegraphics[width=0.7\textwidth]{../graphics/Vis_resnet_comparison_3d.png}}\\
  \subfloat{\includegraphics[width=0.7\textwidth]{../graphics/Vis_resnet_comparison2_3d.png}} 
  \source{From \cite{Li:2018}}
\end{figure}
\end{frame}
