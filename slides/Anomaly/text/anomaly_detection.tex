...
\begin{frame}{Basic principles}
  ...
  \begin{itemize}
  \item   Let $E$ be a set (the whole set of images), $\mathcal{N}$ the subset of $E$ (constituted by all normal images) and $X$ a subset of $N$ (the set of examples that are considered to be \emph{normal}, i.e. the \alert{training set}).
