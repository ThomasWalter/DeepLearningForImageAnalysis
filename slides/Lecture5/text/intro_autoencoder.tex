...
\begin{enumerate}
\item Cycle-Consistent Adversarial Networks for Biological Images (Mines + L'Oreal)
\begin{figure}
\includegraphics[width=.55\columnwidth]{../graphics/Stage1}
\end{figure}
\item Learning to Count by Deep Learning for Biological Images (Mines + LOreal)
\begin{figure}
\includegraphics[width=.55\columnwidth]{../graphics/Stage2}
\end{figure}
\end{enumerate}
\end{frame}
...
\begin{frame}{Job Offers: Master Internships}
\begin{enumerate}
\item Deep Detection with temporal information on Material Science (Mines + Safran)
\begin{figure}
\includegraphics[width=.55\columnwidth]{../graphics/Stage3}
\end{figure}
\item Unsupervised Deep Learning Model for Manifold Data (PostDoc), Mines+Thales)
\begin{figure}
\includegraphics[width=.55\columnwidth]{../graphics/Stage4}
\caption{Image from: \texttt{Latent Space Oddity: On the Curvature of Deep Generative Models}}
\end{figure}
\end{enumerate}
\end{frame}
