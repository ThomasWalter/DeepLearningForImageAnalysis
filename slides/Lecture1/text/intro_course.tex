...
\begin{columns}
  ...
  \begin{column}{.55\textwidth}
    \begin{block}{Teaching assistants}
      \begin{itemize}
        \item Monday: Joseph Boyd, Kaiwen Cheng
...
Tuesday                    & \begin{tabular}[c]{@{}l@{}}Introduction to Convolutional Neural Networks\\ Application to image classification\end{tabular} & \begin{tabular}[c]{@{}l@{}}Pierre Fillard\\ Terapixel \end{tabular}                                                                           \\ \hline
Wednesday                  & \begin{tabular}[c]{@{}l@{}}Image transformations and semantic segmentation\\ Optimisation\end{tabular}          & \begin{tabular}[c]{@{}l@{}}Marc Huertas-Company\\ Paris Observatory \end{tabular} \\ \hline
Thursday                   & \begin{tabular}[c]{@{}l@{}}Practical considerations\\ Applications in robotics\end{tabular}                                    & \begin{tabular}[c]{@{}l@{}}Bogdan Stanciulescu\\ MINES ParisTech\end{tabular}       \\ \hline
