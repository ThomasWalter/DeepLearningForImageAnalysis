...
\frame{
  ...
  \begin{block}{Santiago Velasco-Forero}
    \begin{itemize}
    \item Researcher on image processing, pattern recognition, multivariate statistics
    \item Main application fields: Dermatology, cosmetology, hyperspectral imaging, astronomy
    \end{itemize}
  \end{block}
