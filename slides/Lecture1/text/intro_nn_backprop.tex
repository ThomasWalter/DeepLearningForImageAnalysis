...
\begin{frame}{Batch processing}
  ...
  In a training context, our learning set contains $n$ samples of vectors of length $p$, that can be grouped into an matrix $X$ of size $n \times p$. The $n$ corresponding outputs $y_i$ can also be grouped into a vector $\y$ of length $n$. The resulting equations are:
...
%% \only<1>{\includegraphics[width=\textwidth]{../graphics/bp_simple_1.png}}
%% \only<2>{\includegraphics[width=\textwidth]{../graphics/bp_simple_2.png}}
%% \only<3>{\includegraphics[width=\textwidth]{../graphics/bp_simple_3.png}}
%% \only<4>{\includegraphics[width=\textwidth]{../graphics/bp_simple_4.png}}
%% \only<5>{\includegraphics[width=\textwidth]{../graphics/bp_simple_5.png}}
%% \only<6>{\includegraphics[width=\textwidth]{../graphics/bp_simple_6.png}}
%% \only<7>{\includegraphics[width=\textwidth]{../graphics/bp_simple_7.png}}
%% \only<8>{\includegraphics[width=\textwidth]{../graphics/bp_simple_8.png}}
...
\end{block}
  ...
  \begin{columns}
    \begin{column}{.4\textwidth}
      \begin{figure}[ht]
        \centering
        \includegraphics[width=0.7\textwidth]{../graphics/act_sigm.png}
      \end{figure}

      \begin{figure}[ht]
        \centering
        \includegraphics[width=\textwidth]{../graphics/network}
      \end{figure}
    ...
    \begin{column}{.6\textwidth}
        ...
        \item More advanced solutions exist: \cite{lecun_efficient_2012,glorot_understanding_2010,he_delving_2015}
        \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
