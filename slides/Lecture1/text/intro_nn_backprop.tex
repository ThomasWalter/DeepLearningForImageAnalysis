...
\frame{
  ...
  \begin{block}{Remarks}
    ...
    \item[-] Gradient tends to zero when input is far from zero
...
\frame{
  ...
  \item The theorem does not say how to optimize the architecture or the parameters for a given learning task
  \end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Backpropagation through an activation function}
...
\begin{frame}<beamer>{Backpropagation through a matrix product}
  ...
  \only<1>{\includegraphics[width=\textwidth]{matrix_mult_1.png}}
  \only<2>{\includegraphics[width=\textwidth]{matrix_mult_2.png}}
  \only<3>{\includegraphics[width=\textwidth]{matrix_mult_3.png}}
  \only<4>{\includegraphics[width=\textwidth]{matrix_mult_4.png}}
