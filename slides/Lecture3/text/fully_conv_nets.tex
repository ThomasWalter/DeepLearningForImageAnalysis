...
\frame{
  ...
  \begin{block}{}
This is more an empirical observation that a mathematical property, but fully-convolutional NNs tend to be robust with respect to errors in the contours position on the ground-truth.
  \end{block}
