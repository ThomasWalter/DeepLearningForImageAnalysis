...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{
  \frametitle{Image-to-image nets architecture}

  \begin{itemize}

  \item Image-to-image netss are based on convolutional layers
...
\frame{
  ...
  \begin{block}{Most commonly used loss functions}
    ...
    \item Cross-entropy: $ -\sum\limits_i y_i\log(\hat{y}_i) + (1-y_i)\log(1-\hat{y}_i)$
    \end{itemize}
