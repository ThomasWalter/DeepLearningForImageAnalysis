...
\begin{frame}{Learning image transformations}
  ...
  \item An image classification task is a function from the set of considered images into a set of labels
      \begin{figure}
      \includegraphics[width=0.35\textheight]{image_classif.png}
      \end{figure}
  \item In many applications, we want to transform an image into another image
      \begin{figure}
      \includegraphics[width=0.35\textheight]{image_transf0.png}
      \end{figure}
  \end{itemize}
...
\frame{
  ...
  \begin{block}{Definition: image-to-image neural network}
    An image-to-image NN is a function that transforms an image into an image of same size:
    \vspace{-1em}
    \begin{align*}
...
\begin{frame}{Other applications}
  ...
  In the following, we will focus on images segmentation.
